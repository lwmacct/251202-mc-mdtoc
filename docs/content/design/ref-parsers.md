...
- [1. 规范标准](#1-规范标准) `:25:26`
  - [1.1 CommonMark](#11-commonmark) `:27:36`
  - [1.2 GFM (GitHub Flavored Markdown)](#12-gfm-github-flavored-markdown) `:37:48`
- [2. 主流解析器对比](#2-主流解析器对比) `:49:50`
  - [2.1 按语言分类](#21-按语言分类) `:51:68`
  - [2.2 框架使用情况](#22-框架使用情况) `:69:86`
- [3. Go 生态解析器详细对比](#3-go-生态解析器详细对比) `:87:88`
  - [3.1 goldmark vs blackfriday](#31-goldmark-vs-blackfriday) `:89:99`
  - [3.2 goldmark 性能](#32-goldmark-性能) `:100:109`
  - [3.3 goldmark 扩展](#33-goldmark-扩展) `:110:131`
- [4. 我们的选择](#4-我们的选择) `:132:133`
  - [4.1 决策：goldmark](#41-决策goldmark) `:134:144`
  - [4.2 GitHub Anchor Link 规则](#42-github-anchor-link-规则) `:145:171`
  - [4.3 参考实现](#43-参考实现) `:172:179`
- [5. 未来扩展](#5-未来扩展) `:180:181`
  - [5.1 VitePress 支持 (P2)](#51-vitepress-支持-p2) `:182:192`
  - [5.2 Hugo 支持 (P2)](#52-hugo-支持-p2) `:193:206`
- [6. 参考资料](#6-参考资料) `:207:213`
